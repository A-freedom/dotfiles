# Generated by Powerlevel10k configuration wizard on 2024-07-12 at 15:50 +03.
...
() {
  ...
  typeset -g POWERLEVEL9K_VIRTUALENV_{LEFT,RIGHT}_DELIMITER=true
...
export POWERLEVEL9K_TIME_BACKGROUND_UPDATE=15  # Update time every minute
