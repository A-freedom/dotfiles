...
model.compile(optimizer=custom_optimizer, loss='val_loss', metrics=["mean_absolute_percentage_error"])

# %%
# Early stopping callback
early_stopping = EarlyStopping(monitor='val_mean_squared_error', patience=5000, restore_best_weights=True)
