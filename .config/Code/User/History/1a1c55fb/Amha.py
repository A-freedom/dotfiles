...
model.compile(optimizer=custom_optimizer, loss='mean_absolute_error', metrics=["mean_absolute_percentage_error"])
...
# %%
# Train the model
model.fit(X_train, y_train, epochs=500000, batch_size=5000, verbose=2, validation_split=0.2, callbacks=[early_stopping, checkpoint, tensorboard])
