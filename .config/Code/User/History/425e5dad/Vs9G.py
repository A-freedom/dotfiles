...
model.compile(optimizer=custom_optimizer, loss='mape',  metrics=["mape","mse"])

# %%
# Early stopping callback
early_stopping = EarlyStopping(monitor='val_mape', patience=5000, restore_best_weights=True)
