...
early_stopping = EarlyStopping(monitor='val_mape', patience=1000, restore_best_weights=True)
...
# Train the model
model.fit(X_train, y_train, epochs=22000, batch_size=len(X_train), verbose=2, validation_data=(X_test, y_test),
