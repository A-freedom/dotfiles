...
model.compile(optimizer='adam', loss='mean_absolute_percentage_error', metrics=["mae"],learning_rate=0.001)

# %%
model.fit(X_train, y_train, epochs=3000, batch_size=32,verbose=2,)
