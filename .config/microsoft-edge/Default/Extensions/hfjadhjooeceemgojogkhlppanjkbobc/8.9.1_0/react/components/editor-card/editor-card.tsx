...
type InitialContentProps = RephraseContentProps | ErrorContentProps | ToolboxContentProps | null;
...
const useGetContent: UsePropsByModeFn<React.ReactElement | null> = (previousMode, mode, props) => {
	const getComponent = useCallback(() => {
		if (props === null || isUndefined(mode)) {
		...
		} else if (mode === "toolbox" && "config" in props && props.showRuleId) {
